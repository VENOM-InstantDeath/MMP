...
x: gtk.c libvector/vector.o tagreader/tagreader.o tagreader/duration.c
	$(CC) $(CFLAGS) $(LIBS) gtk.c libvector/vector.o tagreader/tagreader.o tagreader/duration.c -o x -g
